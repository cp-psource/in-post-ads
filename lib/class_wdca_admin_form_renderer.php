...
EOMappingJs;
	...
	function create_sessions_box () {
		...
		echo '<div><small>' .
			__('Standardmäßig ist die Verteilung im A/B-Modus zufällig. Durch Aktivieren dieser Option wird der ursprünglich ausgewählte Modus für Ihre Benutzer erzwungen, damit sie über Anforderungen hinweg bestehen bleiben (d. H. Benutzer, die Einstellungen für den A-Modus erhalten haben, werden diese weiterhin sehen und umgekehrt)..', 'wdca') .
		'</small></div>';
	}
