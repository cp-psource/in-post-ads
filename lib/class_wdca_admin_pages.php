...
class Wdca_AdminPages {
	...
	function register_mode_settings ($mode) {
		...
		register_setting($mode, $mode);
		add_settings_section('wdca_settings', __('Custom Ads', 'wdca'), function() {}, "{$mode}-options");
		...
		add_settings_section('wdca_appearance', __('Appearance &amp; messages', 'wdca'), function() {}, "{$mode}-options");
		...
		add_settings_section('wdca_advanced', __('Advanced', 'wdca'), function() {}, "{$mode}-options");
